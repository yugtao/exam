...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="eUserController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						    <input id="userSchool" name="userSchool" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore"  value='${eUserPage.userSchool}'/>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						    <input id="userMajor" name="userMajor" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore"  value='${eUserPage.userMajor}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="userGDate" name="userGDate" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore"  value='${eUserPage.userGDate}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="userWorkDate" name="userWorkDate" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore"  value='${eUserPage.userWorkDate}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="userCode" name="userCode" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore"  value='${eUserPage.userCode}'/>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						    <input id="userAdress" name="userAdress" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore"  value='${eUserPage.userAdress}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="userTel" name="userTel" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore"  value='${eUserPage.userTel}'/>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						    <input id="userEmail" name="userEmail" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore"  value='${eUserPage.userEmail}'/>
							<span class="Validform_checktip"></span>
