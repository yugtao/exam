...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="eExamList" checkbox="true" fitColumns="true" title="考试表" sortName="id" actionUrl="eExamController.do?datagrid" idField="id" fit="true" queryMode="group">
