...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="ePlaceController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="pInfo" name="pInfo" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="pCount" name="pCount" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore" datatype="n"  errormsg="请输入数字"/>
							<span class="Validform_checktip"></span>
