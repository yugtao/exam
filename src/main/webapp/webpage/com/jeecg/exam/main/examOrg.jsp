...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="eWorkList" checkbox="false" pagination="true" fitColumns="true" title="发布中的考试" sortName="id" actionUrl="eStudentController.do?orgWorks" idField="id" fit="true" queryMode="group">
   <t:dgCol title="主键"  field="id"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="职位所属单位"  field="wOrg" hidden="true" queryMode="single"  dictionary="t_s_depart,id,departname"  width="180"></t:dgCol>
